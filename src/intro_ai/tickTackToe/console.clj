(ns intro-ai.tickTackToe.console
  (:use
    [intro-ai.tickTackToe.core :only [valid-move? place-on-board make-board final-message game-over? winner]]
    [intro-ai.tickTackToe.ai :only [computer-mover]]))
